...
public class Set_Mismatch_645 {
    ...
    // Using an extra array to store the count of occurrence of all numbers
    // Time: O(n)
    // Space: O(n)
    ...
    public static void main(String[] args) {
        ...
        int[] test3 = new int[] { 1, 1, 3, 4 };
        System.out.println(Arrays.toString(findErrorNums2(test3))); // [1, 2]
    }
